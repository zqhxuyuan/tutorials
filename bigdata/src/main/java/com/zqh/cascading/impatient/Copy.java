...
public class Copy {
    ...
    public static void main(String[] args) {
        // local
        args = new String[]{Common.filePath("data/cascading/rain.txt"), Common.filePath("output/rain")};
        // hdfs
        args = new String[]{Common.hdfsUrl()+"/input/cascading/impatient/rain.txt",Common.hdfsUrl()+"/output/cascading/copy",};
