...
public class ClassLoaderUtilTest extends CachedLogger {
    ...
    public void loadServiceClass_ClassNameServiceId() throws Exception {
        ...
        assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass("com.baidu.unbiz.common.sample.MyService",
                "com.baidu.unbiz.common.sample.MyService", getClass().getClassLoader()));
        assertEquals(MyService.class, ClassLoaderUtil.loadServiceClass("com.baidu.unbiz.common.sample.MyService",
                "com.baidu.unbiz.common.sample.MyService", (ClassLoader) null));

        assertEquals(MyService.class,
                ClassLoaderUtil.loadServiceClass("com.baidu.unbiz.common.sample.MyService", "abc"));
    ...
    public void newInstance() throws Exception {
        ...
        try {
            ClassLoaderUtil.newInstance("com.baidu.unbiz.common.sample.MyErrorService");
        ...
        try {
            ClassLoaderUtil.newInstance("com.baidu.unbiz.common.sample.MyErrorService", getClass());
            fail("Expected ClassInstantiationException");
        } catch (ClassInstantiationException e) {
        }
        ...
        try {
            ClassLoaderUtil.newInstance("com.baidu.unbiz.common.sample.MyErrorService", getClass().getClassLoader());
            fail("Expected ClassInstantiationException");
        } catch (ClassInstantiationException e) {
        }
    }
    ...
    public void newServiceInstance() throws Exception {
        ...
        try {
            assertEquals(MyService.class, ClassLoaderUtil.newServiceInstance("com.baidu.unbiz.common.sample.MyService",
                    getClass().getClassLoader()));
            fail("expected ServiceNotFoundException");
        } catch (ServiceNotFoundException e) {
        }
        ...
        try {
            assertEquals(MyService.class,
                    ClassLoaderUtil.newServiceInstance("com.baidu.unbiz.common.sample.MyService", (ClassLoader) null));
            fail("expected ServiceNotFoundException");
        } catch (ServiceNotFoundException e) {
        }
    }
    ...
    public void newServiceInstance_ClassNameServiceId() throws Exception {
        ...
        assertInstance(MyService.class, ClassLoaderUtil.newServiceInstance("com.baidu.unbiz.common.sample.MyService",
                "com.baidu.unbiz.common.sample.MyService", getClass().getClassLoader()));
        assertInstance(MyService.class, ClassLoaderUtil.newServiceInstance("com.baidu.unbiz.common.sample.MyService",
                "com.baidu.unbiz.common.sample.MyService", (ClassLoader) null));

        assertInstance(MyService.class,
                ClassLoaderUtil.newServiceInstance("com.baidu.unbiz.common.sample.MyService", "abc"));
