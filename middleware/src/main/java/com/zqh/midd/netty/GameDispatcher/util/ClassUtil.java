...
public class ClassUtil {
	 ...
	 * 遍历包com.zqh.midd.netty.GameDispatcher.msg
	 * 取得消息类的class文件
	 *
	...
	public static void initTypeToMsgClassMap()
		...
		Set<Class<?>> classSet = getClasses("com.zqh.midd.netty.GameDispatcher.msg");
		if (classSet != null) {
	 ...
	 * 遍历包com.zqh.midd.netty.GameDispatcher.exec
	 * 取得业务逻辑执行器的class文件
	 *
	 * @throws ClassNotFoundException
	 * @throws java.io.IOException
	...
	public static void initTypeToExecutorClassMap()
		...
		Set<Class<?>> classSet = getClasses("com.zqh.midd.netty.GameDispatcher.exec");
		if (classSet != null) {
			for (Class<?> clazz : classSet) {
				if (clazz.isAnnotationPresent(UserMsgAndExecAnnotation.class)) {
					UserMsgAndExecAnnotation annotation = clazz.getAnnotation(UserMsgAndExecAnnotation.class);
