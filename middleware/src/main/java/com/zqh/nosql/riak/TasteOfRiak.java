 ...
 *
 * 测试方法:
 * 1. 启动riak后台进程 :  sudo riak start
 *    查看riak进程:       ps -ef | grep riak
 * 2. 运行测试类
 * 3. 查看控制台结果
 * -------------------------------------------
 ...
 INFO - RiakNode started; 127.0.0.1:8087
 INFO - RiakCluster is starting.
 ...
 INFO - RiakCluster is shutting down.
 INFO - All operations have completed
 INFO - Retrier shutting down.
 INFO - RiakNode shutting down; 127.0.0.1:8087
 INFO - NodeManager removed node due to it shutting down; 127.0.0.1:8087
 INFO - RiakCluster has shut down
 * --------------------------------------------
 */
