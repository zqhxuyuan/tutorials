...
public class Greeting extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Greeting\",\"namespace\":\"example.proto\",\"fields\":[{\"name\":\"message\",\"type\":\"string\"}]}");
  ...
  public static example.proto.Greeting.Builder newBuilder() {
    return new example.proto.Greeting.Builder();
  }
  
  /** Creates a new Greeting RecordBuilder by copying an existing Builder */
  public static example.proto.Greeting.Builder newBuilder(example.proto.Greeting.Builder other) {
    return new example.proto.Greeting.Builder(other);
  }
  
  /** Creates a new Greeting RecordBuilder by copying an existing Greeting instance */
  public static example.proto.Greeting.Builder newBuilder(example.proto.Greeting other) {
    return new example.proto.Greeting.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Greeting>
    ...
    private Builder() {
      super(example.proto.Greeting.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(example.proto.Greeting.Builder other) {
      super(other);
    ...
    private Builder(example.proto.Greeting other) {
            super(example.proto.Greeting.SCHEMA$);
      if (isValidValue(fields()[0], other.message)) {
        this.message = data().deepCopy(fields()[0].schema(), other.message);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'message' field */
    public example.proto.Greeting.Builder setMessage(java.lang.CharSequence value) {
    ...
    public example.proto.Greeting.Builder clearMessage() {
      message = null;
