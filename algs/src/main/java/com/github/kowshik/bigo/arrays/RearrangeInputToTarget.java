...
/**
 * You are given two integer com.github.kowshik.bigo.arrays: input and target. These com.github.kowshik.bigo.arrays contain the
 * same unique integers, and always the value zero in each of them. Also, the
 * target array is some permutation of the input array and both com.github.kowshik.bigo.arrays are of
 * the same size.
 *
