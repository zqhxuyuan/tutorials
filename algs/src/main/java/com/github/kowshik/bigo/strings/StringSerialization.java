package com.github.kowshik.bigo.strings;

/**
 * Methods to serialize/deserialize an array of Strings.
 *
 * i.e. Assume: String[] com.github.kowshik.bigo.strings = {"abcd", "efgh"};
 *
 * Then, the following always returns true as the serialize and deserialize
 * methods are consistent:
 *
 * java.util.Arrays.equals(deserializeStrings(serializeStrings(com.github.kowshik.bigo.strings)),
 * com.github.kowshik.bigo.strings);
 */
public class StringSerialization {
	/**
	 * Serializes an array of com.github.kowshik.bigo.strings into bytes.
	 *
	 * @param strings
	 *            array of com.github.kowshik.bigo.strings to be deserialized
	 * @return array of bytes representing the string
	 */
	public static byte[] serializeStrings(String[] strings) {
		if (strings == null) {
			throw new NullPointerException("com.github.kowshik.bigo.strings can't be null.");
		}
	...
	/**
	 * Deserializes an array of com.github.kowshik.bigo.strings from bytes. NOTE: The array of com.github.kowshik.bigo.strings
	 * should have been serialized using: {@link #serialize(String[])}.
	 *
	 * @param bytes
	 *            array of bytes to be deserialized
	 * @return deserialized array of com.github.kowshik.bigo.strings
	 */
