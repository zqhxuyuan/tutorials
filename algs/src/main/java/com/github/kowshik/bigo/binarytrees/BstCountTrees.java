package com.github.kowshik.bigo.binarytrees;

/**
 * Suppose you are building an N node binary search tree with the values 1..N.
 * How many structurally different binary search com.github.kowshik.bigo.trees are there that store
 * those values? Write a recursive function that, given the number of distinct
 * values, computes the number of structurally unique binary search com.github.kowshik.bigo.trees that
 * store those values.
 * 
 ...
 * are 14 structurally unique binary search com.github.kowshik.bigo.trees that store 1, 2, 3, and 4.
 */
