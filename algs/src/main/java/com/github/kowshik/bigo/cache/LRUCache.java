...
/**
 * A bounded com.github.kowshik.bigo.cache that evicts keys based on least recently used strategy.
 * 
 * @param <CacheKeyType>
...
public class LRUCache<CacheKeyType, CacheValueType> implements
	...
	private CacheNode<CacheKeyType, CacheValueType> evict() {
		if (head == null) {
			throw new AssertionError("Cannot evict a node from an empty com.github.kowshik.bigo.cache.");
		}
