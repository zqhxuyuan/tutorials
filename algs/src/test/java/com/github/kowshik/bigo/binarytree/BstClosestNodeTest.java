package com.github.kowshik.bigo.binarytree;
...
import com.github.kowshik.bigo.binarytrees.BstClosestNode;
import com.github.kowshik.bigo.binarytrees.TreeNode;
...
public class BstClosestNodeTest {
	...
	public void treeWithNoInorderPredecessorAndSubtreeInorderSuccessor() {
		...
		TreeNode<Integer> answer = com.github.kowshik.bigo.binarytrees.BstClosestNode.findClosestNode(
				root, rootLeft);
