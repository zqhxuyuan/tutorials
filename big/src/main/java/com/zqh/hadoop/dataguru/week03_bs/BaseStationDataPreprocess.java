...
public class BaseStationDataPreprocess extends Configured implements Tool {
     ...
     * start-yarn.sh
     *
     * hadoop fs -put NETWORK /input/hadoop/week03
     * hadoop fs -put POSITION /input/hadoop/week03
     *
     * hadoop fs -ls /output/hadoop/week03/network
     * hadoop fs -cat /output/hadoop/week03/network/part-r-00000
     0000000001|0000-0001|09-17|55.0
     *
     * hadoop fs -ls /output/hadoop/week03/position
     * hadoop fs -cat /output/hadoop/week03/position/part-r-00000
     0000000001|0000-0002|09-17|30.0
     0000000001|0000-0001|09-17|15.0
     */
    public static void main(String[] args) throws Exception {
        // 1. local fs
        args = new String[]{"/home/hadoop/data/hadoop/NETWORK",
                            "/home/hadoop/data/hadoop/network",
                            "2013-09-12",
                            "09-17-24"};
        // 2. hdfs - network
        /**
        args = new String[]{Common.hdfsUrl()+"input/hadoop/week03/NETWORK",
                            Common.hdfsUrl()+"output/hadoop/week03/network",
                            "2013-09-12",
                            "09-17-24"};
         */
        // 3. hdfs - position
        args = new String[]{Common.hdfsUrl()+"input/hadoop/week03/POSITION",
                            Common.hdfsUrl()+"output/hadoop/week03/position",
                            "2013-09-12",
                            "09-17-24"};
