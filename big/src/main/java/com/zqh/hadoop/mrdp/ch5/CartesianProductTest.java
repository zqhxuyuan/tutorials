...
public class CartesianProductTest {
	...
	public static void main(String[] args) throws IOException,
		...
		job.setInputFormat(CartesianProduct.CartesianInputFormat.class);
		CartesianProduct.CartesianInputFormat.setLeftInputInfo(job, TextInputFormat.class,
                System.getProperty("user.dir") + "/A");
		CartesianProduct.CartesianInputFormat.setRightInputInfo(job, TextInputFormat.class,
